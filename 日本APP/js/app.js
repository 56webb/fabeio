document.addEventListener('DOMContentLoaded', () => {
  ...
  const itineraryData = [
    ...
    { date: '5/8', location: '白川鄉/上高地', type: 'shirakawa', desc: '合掌村、上高地', detail: '白川鄉合掌村（聯合國列入世界遺產、國家指定重要傳統建築物群保存區）。下午前往日本阿爾卑斯仙境/神之故鄉上高地（路經大正池、眺望穗高連峰、河童橋）。<br>🏨 住宿：緣之杜山中湖溫泉飯店 (0555-72-8084)<br><br>🛍️ <b>⚠️ 山區採買注意：</b><br>• 此飯店位處山中湖畔，<b>方圓 1 公里內「沒有」任何超商或超市</b>！(OGINO 山中湖店距離約 2.5~3 公里，步行無法抵達)。<br>• <b>強烈建議</b>：今日行程結束上山回飯店前，請務必在平地的超商或遊覽車休息站先買好今晚要吃的零食、水果與飲料！' },
